...
public class EmployeePayrollController {
    ...
    public ResponseEntity<ResponseDTO> getEmployeePayrollData() {
        ...
        employeePayrollData = new EmployeePayrollData(1, new EmployeePayrollDTO("Shardul", 50000));
    ...
    public ResponseEntity<ResponseDTO> getEmployeePayrolIData(@PathVariable(value = "empId") int empId) {
        EmployeePayrollData employeePayrollData = null;
        employeePayrollData = new EmployeePayrollData(empId, new EmployeePayrollDTO("Tom", 100000));
